...
interface PromptFieldProps {
  ...
  /**
   * Opens the saved-prompts library. Only passed for fields a generated
   * prompt makes sense in (the positive prompt) — omitted elsewhere, which
   * hides the button.
   */
  onPickSaved?: () => void;
}
      ...
      <View style={styles.actions}>
        {!!onPickSaved && (
          ...
          >
            ...
            />
            <Text style={styles.actionLabel}>{t('prompt.library')}</Text>
          </Pressable>
        )}
        {hasValue && (
          <Pressable
